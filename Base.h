	...
	for (int i = 0; i < itemCount; i++) {
		...
		for (string& prop : properties) {
			if (prop == "NoSeed") {
				...
				def.untradeable = 1;
				if (def.id == 278 || def.id == 11818 || def.id == 9524 || def.id == 9526 || def.id == 9520 || def.id == 9522 || def.id == 9492 || def.id == 9168 || def.id == 7962 || def.id == 5190 || def.id == 8428 || def.id == 5196 || def.id == 5194 || def.id == 11478 || def.id == 1442 || def.id == 11466 || def.id == 11288 || def.id == 11134 || def.id == 10396 || def.id == 12566 || def.id == 11562 || def.id == 5156 || def.id == 5160 || def.id == 5172 || def.id == 5174 || def.id == 5176 || def.id == 5154 || def.id == 9532 || def.id == 9534 || def.id == 9540) def.untradeable = 0; // rift wings 
			} if (prop == "Wrenchable") {
		...
		if (i == 12566) {
			items[i].noob_item = { {12584,1}, {12586,1}, {12570,5}, {12572,5}, {12574,1}, {12588,5}, {12594,5}, {12592,5}, {12590,1} };
			items[i].rare_item = { {12576,1}, {12578,1}, {12580,1}, {12582,1}, {12422,1}, {12424,1}, {12426,1}, {12428,1} };
			items[i].newdropchance = 90;
		}
		...
		if (i == 11756)  items[i].pwl = 10;
		if (i == 1584)  items[i].pwl = 25;
		...
		if (i == 11752 || i == 6950 || i == 6952 || i == 9114)  items[i].pwl = 1500;
